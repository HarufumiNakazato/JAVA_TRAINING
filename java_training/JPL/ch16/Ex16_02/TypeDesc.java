    	...
    	private void printType(Type type, int depth, String[] labels){
    	    ...
    	    if(cls != Object.class){
    	    	if(cls.getEnclosingClass() == null)
    	    		out.print("Non netsted: " + labels[kind] + " " + cls.getCanonicalName());
    	    	else{
    	    		out.print("Nested :" + labels[kind] + " " + cls.getCanonicalName());
    	    		out.print("Enclosing:" + labels[kind] + " " + cls.getEnclosingClass().getName()) ;
    	    	}
    	    }
